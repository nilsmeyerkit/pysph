...
do
  ...
  sqsub -q threaded -n 16 -o /home/nmeyer7/ar=${ar}.log -r 10h --mpp 2.5G pysph run fiber.channel --ar ${ar} --rot 10 --holdcenter --D 100000 --openmp
done
