...
fluidres=1
pysph run ebg.nearfield --ar 20 --g 10 --massscale 1E8 --fluidres $fluidres --pb
mv nearfield_output/ \
~/Dropbox/Thesis/Documentation/SPH/Nearfield/Res_${fluidres}_poiseuielle/

fluidres=0.5
pysph run ebg.nearfield --ar 20 --g 10 --massscale 1E8 --fluidres $fluidres --pb --openmp
mv nearfield_output/ \
~/Dropbox/Thesis/Documentation/SPH/Nearfield/Res_${fluidres}_poiseuielle/
